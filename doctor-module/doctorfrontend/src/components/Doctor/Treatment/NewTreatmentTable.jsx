...
const NewTreatmentTable = () => {
  ...
  const fetchTreatmentData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getTreatmentDataViaBranchAndTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const updateAppointmentStat = async () => {
    try {
      const res = await axios.put(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/updateAppointStatus/${appoint_id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const generateFinalBill = async () => {
    ...
    try {
      const res = await axios.post(
        "https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/generateFinalBillwithTpid",
        billInputField,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const getExamintionTeeth = async () => {
    try {
      const res = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getExaminedataById/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
