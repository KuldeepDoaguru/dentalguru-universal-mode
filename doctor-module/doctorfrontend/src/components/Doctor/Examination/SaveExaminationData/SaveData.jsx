  ...
  const handleSubmit = async (id, e) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/updatedentalPediatric/${id}`,
        formData,
        {
          headers: {
            "Content-Type": "application/json",
    ...
    try {
      ...
      if (confirmed) {
        const res = await axios.delete(
          `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/deleteDentalPediatric/${id}`,
          {
            headers: {
              "Content-Type": "application/json",
              Authorization: `Bearer ${token}`,
