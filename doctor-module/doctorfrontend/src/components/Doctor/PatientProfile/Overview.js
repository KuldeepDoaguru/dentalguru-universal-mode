...
const Overview = () => {
  ...
  const getPresDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getPrescriptionDetailsById/${pid}`
      );
      setPresData(data);
    } catch (error) {
      // console.log(error);
  ...
  const getPendingBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getPatientBillByBranchAndId/${pid}`
      );
      // console.log(data);
  ...
  const getAppointDetailsPat = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getAllAppointmentByPatientId/${uhid}/${branch}`,
        {
          headers: {
  ...
  const getExamineDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/examinDetailsByPatId/${pid}`
      );
      // setExmData(data);
    } catch (error) {
      // console.log(error);
  ...
  const fetchLatestDentalPatientData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getExaminationViaUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const fetchLatestTreatPatientData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getTreatmentViaUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const fetchLatestPrescriptionPatientData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getPrescriptionViaUhid/${branch}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const fetchLatestBillPatientData = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/get-patientBill-data/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const onGoingTreat = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/onGoingTreat/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
