  ...
  const getBranches = async () => {
    try {
      const { data } = await axios.get(
        "https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/get-branches"
      );
      // console.log(data);
      setBranches(data);
    } catch (error) {
  ...
  const receptionistLogin = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/doctor-login",
        {
          email,
          password,
