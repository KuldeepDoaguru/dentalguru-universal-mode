...
const AppointTable = () => {
  ...
  const fetchAppointments = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getAppointmentsWithPatientDetailsTreatSugg/${doctorId}`,
        {
          headers: {
  ...
  const getTreatPackageData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/getTreatPackageViaTpidUhid/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const handleAction = async (
    ...
    try {
      ...
      await axios.put(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/upDateAppointmentStatus`,
        requestBody,
        {
          headers: {
            "Content-Type": "application/json",
      ...
      const res = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/appointtreatSitting?date=${selectedDate}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
