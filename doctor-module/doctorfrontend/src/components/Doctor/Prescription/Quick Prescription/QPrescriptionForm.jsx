...
const QPrescriptionForm = () => {
  ...
  const fetchAppointments = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/get-Patient-by-id/${patient_uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `https://dentalguru-global-doctor.vimubds5.a2hosted.com/api/doctor/insertPatientPrescription`,
        formData
        // {
        //   headers: {
        //     "Content-Type": "application/json",
