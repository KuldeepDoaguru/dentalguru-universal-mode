...
function SittingBillPayment() {
  ...
  const getPatient = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-Patient-by-id/${branch}/${uhid}`,
        {
          headers: {
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getSittingBillDueBySittingId/${branch}/${sbid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getAllSittingBill = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getPaidSittingBillbyTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const updateBillforSitting = async () => {
    try {
      const res = await axios.put(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/updateBillforSitting/${branch}/${tpid}`,
        billUpdateForm,
  ...
  const submitSittingBill = async () => {
    ...
    try {
      const res = await axios.put(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/updateSittingBillPayment/${sbid}/${branch}`,
        formDetails,
        {
          headers: {
            "Content-Type": "application/json",
