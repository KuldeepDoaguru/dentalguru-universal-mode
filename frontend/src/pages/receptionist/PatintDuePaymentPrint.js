...
function PatintDuePaymentPrint() {
  ...
  const getPatientDetailsByBill = async () => {
    try {
      const response = axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getPatientDetailsForBill/${branch}/${uhid}/${bid}`,
        {
          headers: {
  ...
  const secuirtyAmtBytpuhid = async () => {
    try {
      const res = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getSecurityAmountDataByTPUHID/${tpid}/${uhid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getPatientBillsAndSecurityAmountByBranch/${branch}/${bid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const updateRemainingSecurity = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/updateRemainingSecurityAmount/${tpid}/${uhid}`,
        {
  ...
  const makePayment = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.put(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/makeBillPayment/${branch}/${bid}`,
        {
  ...
  const updateTreatmentPackages = async () => {
    try {
      const res = await axios.put(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/updateTreatmentStatus/${branch}/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const updatePatientBill = async () => {
    try {
      const res = await axios.put(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/completePatientBill/${tpid}/${branch}`
      );
      console.log(res);
      updateTreatmentPackages();
