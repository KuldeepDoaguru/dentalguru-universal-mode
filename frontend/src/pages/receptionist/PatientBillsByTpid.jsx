...
const PatientBillsByTpid = () => {
  ...
  const getBranchDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getBranchDetailsByBranch/${branch}`
      );
      console.log(data);
      setGetBranch(data);
    } catch (error) {
  ...
  const getPatientDetail = async () => {
    try {
      const res = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getAppointmentsWithPatientDetailsById/${tpid}`,
        {
          headers: {
  ...
  const getExaminDetail = async () => {
    try {
      const res = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getDentalDataByTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getTreatDetail = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getTreatmentDetailsViaTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getTreatPrescriptionByAppointId = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getTreatPrescriptionByTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getTreatmentSuggestAppointId = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getTreatSuggestViaTpid/${tpid}/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/billDetailsViaTpid/${tpid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const sendPrescriptionMail = async () => {
    ...
    const imgData = canvas.toDataURL("image/jpeg", 0.75); // Use JPEG with 75% quality
      ...
      const response = await axios.post(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/prescriptionOnMail",
        formData,
        {
          headers: {
  ...
  const sendPrescriptionWhatsapp = async () => {
    ...
    const imgData = canvas.toDataURL("image/jpeg", 0.75); // Use JPEG with 75% quality
      ...
      const res = await axios.post(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/sendWhatsapp",
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const billDetailsSms = async () => {
    try {
      const { data } = await axios.post(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/sendSMS",
        formDetails,
        {
          headers: {
            "Content-Type": "application/json",
              ...
              <div className="border">
                ...
                <div className="text-word">
                  <p className="m-0 fw-bold">
                    {numToWords(totalBillvalueWithoutGst)} {"ONLY"}
                  </p>
                </div>
              </div>
              <div className="">
