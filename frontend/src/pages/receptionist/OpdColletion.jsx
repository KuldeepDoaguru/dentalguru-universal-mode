...
function OpdCollection() {
  ...
  <ul class="dropdown-menu">
    ...
    <li><a class="dropdown-item" href="#">All</a></li>
                ...
                <h6 className="mx-2">Total - {user.currentUser.currencySymbol} {total}</h6>
                <h6 className="mx-2">Cash - {user.currentUser.currencySymbol} {cash}</h6>
                <h6 className="mx-2">Credit - {user.currentUser.currencySymbol} {credit}</h6>
                <h6 className="mx-2">UPI  -{user.currentUser.currencySymbol} {upi}</h6>
                <h6 className="mx-2">Card - {user.currentUser.currencySymbol} {card}</h6>
                <h6 className="mx-2">Refund - {user.currentUser.currencySymbol} {refund}</h6>
                </div>
              </nav>
            </div>
                    ...
                    <table className="table table-bordered table-striped">
                      <thead>
                        <tr>
                          ...
                          <th>Treatment</th>
                          <th>App. Status</th>
                          <th>OPD Amount {user.currentUser.currencySymbol}</th>
                          <th>Payment Mode</th>
