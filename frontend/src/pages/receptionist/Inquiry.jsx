...
function Inquiry() {
  ...
  const getInquiries = async () => {
    ...
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-inquiries/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/add-inquiry",
        newData,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const response = await axios.delete(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/delete-inquiry/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
