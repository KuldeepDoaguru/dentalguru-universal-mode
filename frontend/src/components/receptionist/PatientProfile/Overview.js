...
const Overview = () => {
  ...
  const getTreatmentsDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getTreatmentViaUhid/${branch}/${pid}`,
        {
          headers: {
  ...
  const getPrescriptionDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getPrescriptionViaUhid/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getBillDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getBillsViaUhid/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getExaminationDetails = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getExaminationViaUhid/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getAppointDetailsPat = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getAllAppointmentByPatientId/${branch}/${pid}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
          ...
          <div className="col-lg-4" id="tableresponsive1">
            ...
            <div className="d-flex justify-content-center align-item-center mt-2 h-100 w-100 shadow rounded">
              <div className="mt-3">
                ...
                <h5 className="text-center">{user.currentUser.currencySymbol} {total}</h5>
              </div>
            </div>
          </div>
              ...
              <div className="table-responsive">
                ...
                <table className="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>Date</th>
                      <th>Bill Amount ({user.currentUser.currencySymbol})</th>
                      <th>Direct Paid Amount ({user.currentUser.currencySymbol})</th>
                      <th>Pay by Security Amount ({user.currentUser.currencySymbol})</th>
