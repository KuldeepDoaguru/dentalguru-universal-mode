...
function AppDetail({props}) {
 ...
 >
   <div className="table-responsive">
     ...
     <p>Total-{user.currentUser.currencySymbol} 2000</p>
     <div className="card" id="card4">
            ...
            <div className="card-body ">
              ...
              <div className="">
                <h6 className="card-title text-center">On 25 oct ,2023:-{user.currentUser.currencySymbol} 2000/-</h6>
            ...
            <div className="card-body ">
              ...
              <div className="">
                <h6 className="card-title text-center">Total Paid:- {user.currentUser.currencySymbol} 2000/-</h6>
