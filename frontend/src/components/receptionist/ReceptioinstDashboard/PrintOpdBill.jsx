  ...
  const getBill = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-appointment-by-id/${branch}/${appointmentId}`,
        {
          headers: {
              ...
              <table className="table table-borderless">
                ...
                <tbody>
                  <tr>
                    ...
                    {user.currentUser.currencySymbol} {data?.opd_amount || '00'}
                      {".00"}
                    </td>
                  </tr>
