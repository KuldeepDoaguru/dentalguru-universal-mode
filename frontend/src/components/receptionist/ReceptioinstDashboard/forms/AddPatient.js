...
function AddPatient() {
  ...
  const getBranchDetail = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-branch-detail/${branch}`
      );
  ...
  const getInsuranceCompany = async () => {
           try{
            const response = await axios.get(`https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/getInsuranceCompany/${branch}`)
  ...
  const getBranchHolidays = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-branch-holidays/${branch}`,
        {
          headers: {
  ...
  const getPatient = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-Patients/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getAppointments = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-appointments/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getDoctors = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-doctors/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const getDisease = async () => {
    try {
      const response = await axios.get(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-disease"
      );
      console.log(response);
  ...
  const getTreatment = async () => {
    try {
      const response = await axios.get(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-treatments"
      );
      console.log(response);
  ...
  const getDoctorsWithLeave = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/get-doctors-with-leave/${branch}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const timelineData = async (id) => {
    try {
      const response = await axios.post(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/insertTimelineEvent",
        {
          type: "Add Patient",
  ...
  const handleSubmit = async (e) => {
    ...
    if (isSlotAvailable) {
      ...
      try {
        setLoading(true);
        const response = await axios.post(
          "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/add-patient",
          newPatient,
          {
            headers: {
              "Content-Type": "application/json",
