...
function CancleAppointment({ onClose, appointmentInfo, allAppointmentData }) {
  ...
  const handleCancelAppointment = async (e) => {
    ...
    //     await axios.put(`https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/cancel-appointment-status-opd`, newAppointment);
    ...
    try {
      ...
      const response = await axios.put(
        "https://dentalguru-global-receptionist.vimubds5.a2hosted.com/api/v1/receptionist/cancel-appointment-status-opd",
        newAppointment,
        {
          headers: {
            "Content-Type": "application/json",
