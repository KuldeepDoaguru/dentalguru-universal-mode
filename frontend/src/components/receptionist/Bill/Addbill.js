   ...
   <>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <form>
          ...
          <div class="mb-3">
            <label for="message-text" class="col-form-label">Cost {user.currentUser.currencySymbol}:</label>
            <input type="text" class="form-control" id="recipient-name"/>
          </div>
          <div class="mb-3">
            <label for="message-text" class="col-form-label">Discount {user.currentUser.currencySymbol}:</label>
            <input type="text" class="form-control" id="recipient-name"/>
          </div>
          <div class="mb-3">
            <label for="message-text" class="col-form-label">Total {user.currentUser.currencySymbol}:</label>
            <input type="text" class="form-control" id="recipient-name"/>
          </div>
