...
router.get("/getSittingBillDue/:branch", getSittingBillDue);
router.get(
  "/getSittingBillDueBySittingId/:branch/:sbid",
  getSittingBillDueBySittingId
);
router.get("/getPaidSittingBillbyTpid/:tpid/:branch", getPaidSittingBillbyTpid);
router.get("/getSittingBillbyId/:branch/:sbid", getSittingBillDueBySittingId);
router.get("/getEmployeeDetailsbyId/:branch/:eid", getEmployeeDetailsbyId);
router.put("/updateSittingBillPayment/:sbid/:branch", updateSittingBillPayment);
router.get("/getSittingBillData/:branch", getSittingBillData);
router.get(
  "/getPatientDetailsForBill/:branch/:uhid/:billId",
  getPatientDetailsForBill
);
router.put("/updateBillforSitting/:branch/:tpid", updateBillforSitting);
router.put("/updateSittingBillToPaid/:sbid/:branch", updateSittingBillToPaid);
router.put(
  "/ChangeStatusToPaidPatientBill/:bill_id/:branch",
  ChangeStatusToPaidPatientBill
);
router.get("/get-appointments/:branch", getAppointments);
router.put(
  "/ChangeStatusToPaidOPDBill/:appoint_id/:branch",
  ChangeStatusToPaidOPDBill
);
