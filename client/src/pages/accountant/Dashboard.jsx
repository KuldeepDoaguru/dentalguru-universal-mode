...
const Accountant_Dashboard = () => {
  ...
  const filterForUnPaidBills = patBill?.filter((item) => {
    ...
    return item.payment_status === "paid" && itemDate === formattedDate;
  });

  console.log("Filtered Data:", filterForUnPaidBills);
  return (
    <Wrapper>
            ...
            >
              ...
              <div>
                <div className="tab-navigation">
                  ...
                  <button
                    onClick={() => setActiveTab("sitting bill")}
                    className={`tab-button ${
                      activeTab === "sitting bill" ? "active" : ""
                    }`}
                  >
                    Sitting Bills
                  </button>
