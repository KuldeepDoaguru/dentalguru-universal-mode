...
const AttendanceLeave = () => {
  ...
  const getAttendance = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-accountant.vimubds5.a2hosted.com/api/v2/accountant/getAttendancebyempId/${branch}/${employeeId}`,
        {
          headers: {
  ...
  const getLeaves = async () => {
    try {
      const response = await axios.get(
        `https://dentalguru-accountant.vimubds5.a2hosted.com/api/v2/accountant/get-leaves/${branch}/${employeeId}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
