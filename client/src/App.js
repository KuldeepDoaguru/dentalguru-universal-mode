...
import SittingBillDetails from "./pages/SittingBillDetails";
import SittingBillPayment from "./pages/SittingBillPayment";
import SittingBill from "./pages/SittingBill";
import SittingPaidBillDetails from "./pages/SittingPaidBillDetails";
import SittingReport from "./pages/SittingReport";
import Invoices from "./pages/Invoices";
import AllCreditInvoice from "./pages/AllCreditInvoice";
import CreditSittingBill from "./pages/CreditSittingBill";
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/sitting-report"
          element={
            user.employee_name === null ? <UniversalLogin /> : <SittingReport />
          }
        />
        ...
        <Route
          path="/invoices"
          element={
            user.employee_name === null ? <UniversalLogin /> : <Invoices />
          }
        />
