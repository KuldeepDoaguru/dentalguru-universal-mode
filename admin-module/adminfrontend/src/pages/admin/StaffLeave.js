  ...
  const getLeaveList = async () => {
    ...
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-admin.vimubds5.a2hosted.com/api/v1/admin/getLeaveList/${branch}`,
        {
          headers: {
  ...
  const handleLeaveApprove = async (id, employee_id) => {
    ...
    try {
      const response = await axios.put(
        `https://dentalguru-global-admin.vimubds5.a2hosted.com/api/v1/admin/approveLeave/${id}`,
        {
          status: "Approved",
        },
