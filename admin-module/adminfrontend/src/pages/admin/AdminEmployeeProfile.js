...
const EmployeeProfile = () => {
  ...
  const getEmployeeData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-admin.vimubds5.a2hosted.com/api/v1/admin/getEmployeeDetails/${branch}/${eid}`,
        {
          headers: {
  ...
  const editEmployeeData = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://dentalguru-global-admin.vimubds5.a2hosted.com/api/v1/admin/editEmployeeDetails/${branch}/${eid}`,
        formData,
        {
          headers: {
