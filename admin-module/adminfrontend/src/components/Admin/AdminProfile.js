  ...
  const getEmployeeData = async () => {
    try {
      const { data } = await axios.get(
        `https://dentalguru-global-admin.vimubds5.a2hosted.com/api/v1/admin/getEmployeeDetails/${branch}/${user.employee_ID}`,
        {
          headers: {
  ...
  const editEmployeeData = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://dentalguru-global-admin.vimubds5.a2hosted.com//api/v1/admin/editEmployeeDetails/${branch}/${user.employee_ID}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
